...
function inicializar() {
    let viajes = [
        {"clase_pais": "usa", "ciudad_h2": "New York, NY", "detalle_precio_total": "1,899", "detalle_num_noches": 7, "precio_noche": 275, "ruta_imagen": "./photos/newyork1.jpg", "pie_imagen": "Puente Brooklyn"},
        {"clase_pais": "paris", "ciudad_h2": "Paris, Francia", "detalle_precio_total": "1,499", "detalle_num_noches": 5, "precio_noche": 300, "ruta_imagen": "./photos/paris3.jpg", "pie_imagen": "Notre Dame de Paris"},
        {"clase_pais": "uk", "ciudad_h2": "Londres, UK", "detalle_precio_total": "2,199", "detalle_num_noches": 5, "precio_noche": 440, "ruta_imagen": "./photos/london.jpg", "pie_imagen": "Torre de Londres"}
    ];
...
function mostrarViajes(viajes) {
    ...
    viajes.forEach(viaje => {
        ...
        let fotoElementoLista = document.createElement('li');

        let imagen = document.createElement('img');
        imagen.src = viaje.ruta_imagen;
        imagen.alt = viaje.pie_imagen;
        fotoElementoLista.appendChild(imagen);

        let pieImagen = document.createElement('span');
        pieImagen.textContent = viaje.pie_imagen;
        fotoElementoLista.appendChild(pieImagen);
        ...
        fotos.appendChild(fotoElementoLista);
